...
export declare class Container extends InkObject implements INamedContent {
    ...
    content: InkObject[];
    namedOnlyContent: Map<string, InkObject> | null;
    countFlags: number;
    readonly pathToFirstLeafContent: Path;
    readonly internalPathToFirstLeafContent: Path;
    AddContent(contentObjOrList: InkObject | InkObject[]): void;
    TryAddNamedContent(contentObj: InkObject): void;
    AddToNamedContentOnly(namedContentObj: INamedContent): void;
