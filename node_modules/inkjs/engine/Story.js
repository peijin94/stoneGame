...
exports.InkList = InkList_2.InkList;
...
class Story extends Object_1.InkObject {
    ...
    EndProfiling() { }
    ToJsonString() {
        let rootContainerJsonList = JsonSerialisation_1.JsonSerialisation.RuntimeObjectToJToken(this._mainContentContainer);
        let rootObject = {};
        rootObject['inkVersion'] = this.inkVersionCurrent;
        rootObject['root'] = rootContainerJsonList;
        if (this._listDefinitions != null)
            rootObject['listDefs'] = JsonSerialisation_1.JsonSerialisation.ListDefinitionsToJToken(this._listDefinitions);
            ...
            switch (evalCommand.commandType) {
                ...
                case ControlCommand_1.ControlCommand.CommandType.PopTunnel:
                    let popType = evalCommand.commandType == ControlCommand_1.ControlCommand.CommandType.PopFunction ?
                        PushPop_1.PushPopType.Function : PushPop_1.PushPopType.Tunnel;
    ...
    ObserveVariable(variableName, observer) {
        ...
        if (!this.state.variablesState.GlobalVariableExistsWithName(variableName))
            throw new StoryException_1.StoryException("Cannot observe variable '" + variableName + "' because it wasn't declared in the ink story.");
