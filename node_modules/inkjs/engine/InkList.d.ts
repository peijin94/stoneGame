...
export declare class InkListItem implements IInkListItem {
    ...
    static readonly Null: InkListItem;
...
export declare class InkList extends Map<SerializedInkListItem, number> {
    ...
    AddItem(itemOrItemName: InkListItem | string | null): undefined;
    ...
    readonly originNames: string[];
    SetInitialOriginName(initialOriginName: string): void;
    SetInitialOriginNames(initialOriginNames: string[]): void;
    readonly maxItem: KeyValuePair<InkListItem, number>;
    readonly minItem: KeyValuePair<InkListItem, number>;
    ...
    readonly orderedItems: KeyValuePair<InkListItem, number>[];
    toString(): string;
    valueOf(): number;
}
/**
 ...
 */
export declare type SerializedInkListItem = string;
/**
