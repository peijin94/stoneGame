    ...
    class Thread {
        constructor() {
            ...
            if (arguments[0] && arguments[1]) {
                ...
                for (let jElTok of jThreadCallstack) {
                    ...
                    el.temporaryVariables = JsonSerialisation_1.JsonSerialisation.JObjectToDictionaryRuntimeObjs(jObjTemps);
        ...
        get jsonToken() {
            ...
            for (let el of this.callstack) {
                ...
                jObj['type'] = el.type;
                jObj['temp'] = JsonSerialisation_1.JsonSerialisation.DictionaryRuntimeObjsToJObject(el.temporaryVariables);
