...
export declare function tryGetValueFromMap<K, V>(map: Map<K, V> | null, key: K, /* out */ value: V): TryGetResult<V>;
export declare function tryParseInt(value: any, /* out */ defaultValue?: number): TryGetResult<number>;
export declare function tryParseFloat(value: any, /* out */ defaultValue?: number): TryGetResult<number>;
