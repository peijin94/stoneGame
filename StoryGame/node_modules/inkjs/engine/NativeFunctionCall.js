...
class NativeFunctionCall extends Object_1.InkObject {
    ...
    CallType(parametersOfSingleType) {
        ...
        if (paramCount == 2 || paramCount == 1) {
            ...
            if (!opForTypeObj) {
                throw new StoryException_1.StoryException('Cannot perform operation ' + this.name + ' on ' + valType);
            }
            if (paramCount == 2) {
    ...
    CallBinaryListOperation(parameters) {
        ...
        throw new StoryException_1.StoryException('Can not call use ' + this.name + ' operation on ' + v1.valueType + ' and ' + v2.valueType);
    }
        ...
        if (Value_1.ValueType[valType] == Value_1.ValueType[Value_1.ValueType.List]) {
            for (let inkObjectVal of parametersIn) {
                ...
                if (val.valueType == Value_1.ValueType.List) {
                    ...
                    throw new StoryException_1.StoryException('Cannot mix Lists and ' + val.valueType + ' values in this operation');
            }
        }
        else {
            for (let inkObjectVal of parametersIn) {
