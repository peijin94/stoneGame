!function(t, e) {
    ...
    function _(t, e) {
        return function(t) {
            ...
            var n = []
              ...
              , a = void 0;
            try {
                for (var o, u = t[Symbol.iterator](); !(i = (o = u.next()).done) && (n.push(o.value),
                !e || n.length !== e); i = !0)
                    ;
            } catch (t) {
                r = !0,
    ...
    var t, n, x, l, N = function() {
        function s() {
            ...
            } else if (arguments[0]instanceof s.Component && arguments[1]instanceof s) {
                var e = arguments[0]
                  , n = arguments[1];
        ...
        return o(s, [{
            ...
            value: function(t) {
                var e = new s;
                return e._components.push.apply(e._components, this._components),
                ...
                null != this._componentsString && "" != this._componentsString) {
                    ...
                    try {
                        for (var a, o = e[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                            var u = a.value;
                            /^(\-|\+)?([0-9]+|Infinity)$/.test(u) ? this._components.push(new s.Component(parseInt(u))) : this._components.push(new s.Component(u))
                        }
                    } catch (t) {
                        i = !0,
                        r = t
    ...
    var m = function() {
        function t() {
            return k(this, t),
            f(this, c(t).apply(this, arguments))
        }
        return u(t, e(Error)),
        t
    }();
    ...
    var P = function() {
        ...
        return o(t, [{
            ...
            value: function(t) {
                ...
                if (t.isRelative) {
                    var e = St(this, At);
                    return null === e && (x.Assert(null !== this.parent, "Can't resolve relative path because we don't have a parent"),
                    e = St(this.parent, At),
            ...
            get: function() {
                if (null == this._path)
                    if (null == this.parent)
                        ...
                        for (var t = [], e = this, n = St(e.parent, At); null !== n; ) {
                            var i = p(e);
                            null != i && i.hasValidName ? t.unshift(new N.Component(i.name)) : t.unshift(new N.Component(n.content.indexOf(e))),
                            n = St((e = n).parent, At)
                        }
                        this._path = new N(t)
                    }
      ...
      , Tt = function() {
        ...
        return o(i, [{
            ...
            value: function(t) {
                return "object" === O(t) && (!(!t.hasOwnProperty("originName") || !t.hasOwnProperty("itemName")) && (("string" == typeof t.originName || null === typeof t.originName) && ("string" == typeof t.itemName || null === typeof t.itemName)))
            }
        }, {
            key: "Null",
            get: function() {
      ...
      , wt = function() {
        function p() {
            var t, e = arguments;
            if (k(this, p),
            (t = f(this, c(p).call(this, e[0]instanceof p ? e[0] : void 0))).origins = null,
            t._originNames = [],
            arguments[0]instanceof p) {
                ...
                if (!a.exists)
                    throw new Error("InkList origin could not be found in story when constructing new list: " + i);
                t.origins = [a.result]
            } else if ("object" === O(arguments[0]) && arguments[0].hasOwnProperty("Key") && arguments[0].hasOwnProperty("Value")) {
                var o = arguments[0];
                t.Add(o.Key, o.Value)
            }
            return t
        ...
        o(p, [{
            ...
            value: function(t) {
                if (t instanceof Tt) {
                    ...
                    if (null === this.origins)
                        return kt("this.origins");
                    var n = !0
                      , i = !1
                      , r = void 0;
                    try {
                        for (var a, o = this.origins[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                            var u = a.value;
                            if (u.name == e.originName) {
                                var s = u.TryGetValueForItem(e, 0);
                                if (s.exists)
                                    return void this.Add(e, s.result);
                ...
                var c = !0
                  ...
                  , v = void 0;
                try {
                    for (var d, y = this.origins[Symbol.iterator](); !(c = (d = y.next()).done); c = !0) {
                        var p = d.value;
                        if (null === l)
                            return kt("itemName");
                        if (p.ContainsItemWithName(l)) {
                            if (null != h)
                                throw new Error("Could not add the item " + l + " to this list because it could come from either " + p.name + " or " + h.name);
                            h = p
                        }
                    }
                } catch (t) {
                ...
                if (null == h)
                    throw new Error("Could not add the item " + l + " to this list because it isn't known to any list definitions previously associated with this list.");
            ...
            value: function(t) {
                var e = !0
                  ...
                  , i = void 0;
                try {
                    for (var r, a = this[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = _(r.value, 2)
                          , u = o[0];
                        o[1];
                        if (Tt.fromSerializedKey(u).itemName == t)
                            return !0
                    }
                } catch (t) {
                    n = !0,
            ...
            value: function(t) {
                var e = new p
                  ...
                  , r = void 0;
                try {
                    for (var a, o = this[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = _(a.value, 2)
                          , s = u[0]
                          , l = u[1];
                        t.has(s) && e.set(s, l)
            ...
            value: function(t) {
                var e = !0
                  ...
                  , i = void 0;
                try {
                    for (var r, a = t[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = _(r.value, 2)
                          , u = o[0];
                        o[1];
                        if (!this.has(u))
            ...
            value: function(t, e) {
                ...
                Number.isInteger(t) ? i = t : t instanceof p && 0 < t.Count && (i = t.minItem.Value),
                Number.isInteger(e) ? r = e : t instanceof p && 0 < t.Count && (r = e.maxItem.Value);
                var a = new p;
                ...
                var o = !0
                  ...
                  , s = void 0;
                try {
                    for (var l, h = n[Symbol.iterator](); !(o = (l = h.next()).done); o = !0) {
                        var c = l.value;
            ...
            key: "toString",
            value: function() {
                for (var t = this.orderedItems, e = new bt, n = 0; n < t.length; n++) {
                    0 < n && e.Append(", ");
                    var i = t[n].Key;
                    if (null === i.itemName)
                        return kt("item.itemName");
                    e.Append(i.itemName)
                }
                return e.toString()
            }
            ...
            get: function() {
                if (0 < this.Count) {
                    null == this._originNames && 0 < this.Count ? this._originNames = [] : (this._originNames || (this._originNames = []),
                    this._originNames.length = 0);
                    var t = !0
                      , e = !1
                      , n = void 0;
                    try {
                        for (var i, r = this[Symbol.iterator](); !(t = (i = r.next()).done); t = !0) {
                            var a = _(i.value, 2)
                              , o = a[0]
                              , u = (a[1],
                            Tt.fromSerializedKey(o));
                            if (null === u.originName)
                                return kt("item.originName");
            ...
            get: function() {
                ...
                if (null != this.origins) {
                    var e = !0
                      ...
                      , i = void 0;
                    try {
                        for (var r, a = this.origins[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                            var o = r.value
                              , u = !0
                              , s = !1
                              , l = void 0;
                            try {
                                for (var h, c = o.items[Symbol.iterator](); !(u = (h = c.next()).done); u = !0) {
                                    var f = _(h.value, 2)
                                      , v = f[0]
                                      , d = f[1]
            ...
            get: function() {
                ...
                return t.sort(function(t, e) {
                    return null === t.Key.originName ? kt("x.Key.originName") : null === e.Key.originName ? kt("y.Key.originName") : t.Value == e.Value ? t.Key.originName.localeCompare(e.Key.originName) : t.Value < e.Value ? -1 : t.Value > e.Value ? 1 : 0
                }),
                t
            }
        }]),
    ...
    var E, S, C = function() {
        ...
        o(t, [{
            ...
            value: function(t) {
                return new _t("Can't cast " + this.valueObject + " from " + this.valueType + " to " + t)
            }
        }], [{
            key: "Create",
            value: function(t) {
                "boolean" == typeof t && (t = !!t ? 1 : 0);
                return Number.isInteger(Number(t)) ? new Et(Number(t)) : isNaN(t) ? "string" == typeof t ? new Ot(String(t)) : t instanceof N ? new Nt(Ct(t, N)) : t instanceof wt ? new Pt(Ct(t, wt)) : null : new A(Number(t))
            }
        }]),
        t
    }(), xt = function() {
        function n(t) {
            var e;
            return k(this, n),
            (e = f(this, c(n).call(this))).value = t,
            e
        }
        return u(n, C),
        o(n, [{
            key: "toString",
            value: function() {
                return null === this.value ? kt("Value.value") : this.value.toString()
            }
        }, {
            key: "valueObject",
            get: function() {
        ...
        function n(t) {
            ...
            null === e.value ? f(e, kt("Value.value")) : (0 < e.value.length && e.value.split("").every(function(t) {
        ...
        o(n, [{
            ...
            key: "isTruthy",
            get: function() {
                return null === this.value ? kt("Value.value") : 0 < this.value.length
            }
        }, {
            key: "isNewline",
            get: function() {
        ...
        function i(t) {
            ...
            return k(this, i),
            (e = f(this, c(i).call(this, t)))._contextIndex = n,
            e
        }
        return u(i, xt),
        o(i, [{
        ...
        function r(t, e) {
            ...
            t || e ? t instanceof wt ? n.value = new wt(t) : t instanceof Tt && "number" == typeof e && (n.value = new wt({
                Key: t,
                Value: e
            })) : n.value = new wt,
            n
        ...
        o(r, [{
            ...
            key: "isTruthy",
            get: function() {
                return null === this.value ? kt("this.value") : 0 < this.value.Count
            }
        }, {
            key: "valueType",
            get: function() {
        ...
        o(r, null, [{
            ...
            value: function(t, e) {
                var n = St(t, r)
                  , i = St(e, r);
                return i && null === i.value ? kt("newList.value") : n && null === n.value ? kt("oldList.value") : void (n && i && 0 == i.value.Count && i.value.SetInitialOriginNames(n.value.originNames))
            }
        }]),
        r
    }();
    ...
    var b, T, F = function() {
        ...
        o(w, [{
            ...
            value: function(t) {
                x.AssertType(t, P, "Can only add Runtime.Objects to a Runtime.Container"),
            ...
            value: function(t) {
                ...
                var e = !0
                  ...
                  , i = void 0;
                try {
                    for (var r, a = t.content[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = r.value;
            ...
            value: function(t) {
                if (t.isIndex)
                    return 0 <= t.index && t.index < this.content.length ? this.content[t.index] : null;
                if (t.isParent)
                    return this.parent;
                if (null === t.name)
                    return kt("component.name");
            ...
            value: function(t, e, n) {
                ...
                for (var u = 0; u < this.content.length; ++u) {
                    ...
                    if (s instanceof w)
                        s.BuildStringOfHierarchy(i, r, a);
                    else
                        o(),
                        s instanceof Ot ? (i.Append('"'),
                        i.Append(s.toString().replace("\n", "\\n")),
                        i.Append('"')) : i.Append(s.toString());
                ...
                var l = new Map
                  ...
                  , f = void 0;
                try {
                    for (var v, d = this.namedContent[Symbol.iterator](); !(h = (v = d.next()).done); h = !0) {
                        var y = _(v.value, 2)
                          , p = y[0]
                          , m = y[1];
                ...
                if (0 < l.size) {
                    ...
                    var g = !0
                      ...
                      , C = void 0;
                    try {
                        for (var k, b = l[Symbol.iterator](); !(g = (k = b.next()).done); g = !0) {
                            var T = _(k.value, 2);
                            p = T[0],
                            m = T[1];
            ...
            get: function() {
                var t = new Map
                  ...
                  , i = void 0;
                try {
                    for (var r, a = this.namedContent[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = _(r.value, 2)
                          , u = o[0]
                          , s = Ct(o[1], P);
                        t.set(u, s)
                ...
                var l = !0
                  ...
                  , c = void 0;
                try {
                    for (var f, v = this.content[Symbol.iterator](); !(l = (f = v.next()).done); l = !0) {
                        var d = p(f.value);
            ...
            set: function(t) {
                ...
                if (null != t) {
                    var l = !0
                      ...
                      , c = void 0;
                    try {
                        for (var f, v = t[Symbol.iterator](); !(l = (f = v.next()).done); l = !0) {
                            var d = _(f.value, 2)
                              , y = (s = d[0],
                            p(d[1]));
            ...
            get: function() {
                var t = 0;
                return this.visitsShouldBeCounted && (t |= w.CountFlags.Visits),
            ...
            set: function(t) {
                var e = t;
                0 < (e & w.CountFlags.Visits) && (this.visitsShouldBeCounted = !0),
                0 < (e & w.CountFlags.Turns) && (this.turnIndexShouldBeCounted = !0),
                0 < (e & w.CountFlags.CountStartOnly) && (this.countingAtStartOnly = !0)
            }
        }, {
            ...
            get: function() {
                for (var t = [], e = this; e instanceof w; )
                    0 < e.content.length && (t.push(new N.Component(0)),
                    e = e.content[0]);
                return new N(t)
            }
        }]),
    ...
    var w, V, It, L, R = function() {
        ...
        function n() {
            var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : n.CommandType.NotSet;
            return k(this, n),
            (t = f(this, c(n).call(this)))._commandType = e,
            t
        }
        return u(n, P),
        o(n, [{
    ...
    var Vt = function() {
        ...
        return o(e, [{
            ...
            key: "path",
            get: function() {
                return this.isNull ? null : 0 <= this.index ? this.container.path.PathByAppendingComponent(new N.Component(this.index)) : this.container.path
            }
        }], [{
            key: "StartOf",
            value: function(t) {
      ...
      , Lt = function() {
        ...
        o(n, [{
            ...
            value: function(t) {
                var e = t;
                return e instanceof n && this.hasVariableTarget == e.hasVariableTarget && (this.hasVariableTarget ? this.variableDivertName == e.variableDivertName : null === this.targetPath ? kt("this.targetPath") : this.targetPath.Equals(e.targetPath))
            }
        }, {
            key: "toString",
            value: function() {
                ...
                this.pushesToStack && (this.stackPushType == It.Function ? t.Append(" function") : t.Append(" tunnel")),
                t.Append(" -> "),
            ...
            get: function() {
                if (this._targetPointer.isNull) {
                    ...
                    if (this._targetPath.lastComponent.isIndex) {
                        if (null === t)
                            return kt("targetObj");
                        this._targetPointer.container = t.parent instanceof At ? t.parent : null,
      ...
      , D = function() {
        ...
        o(n, [{
            key: "toString",
            value: function() {
                return null === this.pathOnChoice ? kt("ChoicePoint.pathOnChoice") : "Choice: -> " + this.pathOnChoice.toString()
            }
        }, {
            key: "pathOnChoice",
            get: function() {
            ...
            key: "choiceTarget",
            get: function() {
                return null === this._pathOnChoice ? kt("ChoicePoint._pathOnChoice") : this.ResolvePath(this._pathOnChoice).container
            }
        }, {
            key: "pathStringOnChoice",
            get: function() {
                return null === this.pathOnChoice ? kt("ChoicePoint.pathOnChoice") : this.CompactPathString(this.pathOnChoice)
            },
            set: function(t) {
      ...
      , Gt = function() {
        ...
        o(a, [{
            ...
            value: function(t) {
                ...
                try {
                    for (var a, o = t[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = a.value;
                        if (u instanceof Mt)
                            throw new _t('Attempting to perform operation on a void value. Did you forget to "return" a value from a function you called here?');
                        u instanceof Pt && (e = !0)
                    }
                } catch (t) {
                    i = !0,
                ...
                var s = this.CoerceValuesToSingleType(t)
                  , l = s[0].valueType;
                return l == E.Int ? this.CallType(s) : l == E.Float ? this.CallType(s) : l == E.String ? this.CallType(s) : l == E.DivertTarget ? this.CallType(s) : l == E.List ? this.CallType(s) : null
            }
        }, {
            key: "CallType",
            value: function(t) {
                ...
                if (!a)
                    throw new _t("Cannot perform operation " + this.name + " on " + n);
                if (2 == r) {
                    var o = Ct(t[1], xt)
                      , u = a;
            ...
            value: function(t) {
                if (("+" == this.name || "-" == this.name) && t[0]instanceof Pt && t[1]instanceof Et)
                    return this.CallListIncrementOperation(t);
                var e = Ct(t[0], xt)
                  , n = Ct(t[1], xt);
                if (!("&&" != this.name && "||" != this.name || e.valueType == E.List && n.valueType == E.List)) {
                    if (null === this._operationFuncs)
                        return kt("NativeFunctionCall._operationFuncs");
                ...
                throw new _t("Can not call use " + this.name + " operation on " + e.valueType + " and " + n.valueType)
            }
        }, {
            ...
            value: function(t) {
                var e = Ct(t[0], Pt)
                  ...
                  , i = new wt;
                if (null === e.value)
                    return kt("NativeFunctionCall.CallListIncrementOperation listVal.value");
                var r = !0
                  , a = !1
                  , o = void 0;
                try {
                    for (var u, s = e.value[Symbol.iterator](); !(r = (u = s.next()).done); r = !0) {
                        var l = _(u.value, 2)
                          , h = l[0]
                          , c = l[1]
                        ...
                        if (null === n.value)
                            return kt("NativeFunctionCall.CallListIncrementOperation intVal.value");
                        var d = v(c, n.value)
                          , y = null;
                        if (null === e.value.origins)
                            return kt("NativeFunctionCall.CallListIncrementOperation listVal.value.origins");
                        var p = !0
                          , m = !1
                          , g = void 0;
                        try {
                            for (var S, C = e.value.origins[Symbol.iterator](); !(p = (S = C.next()).done); p = !0) {
                                var k = S.value;
            ...
            value: function(t) {
                var e = E.Int
                  ...
                  , a = void 0;
                try {
                    for (var o, u = t[Symbol.iterator](); !(i = (o = u.next()).done); i = !0) {
                        var s = Ct(o.value, xt);
                ...
                if (E[e] == E[E.List]) {
                    var h = !0
                      ...
                      , f = void 0;
                    try {
                        for (var v, d = t[Symbol.iterator](); !(h = (v = d.next()).done); h = !0) {
                            var y = Ct(v.value, xt);
                            if (y.valueType == E.List)
                                l.push(y);
                            else {
                                if (y.valueType != E.Int)
                                    throw new _t("Cannot mix Lists and " + y.valueType + " values in this operation");
                                var p = parseInt(y.valueObject);
                                if (null === (n = Ct(n, Pt)).value)
                                    return kt("NativeFunctionCall.CoerceValuesToSingleType specialCaseList.value");
                                var m = n.value.originOfMaxItem;
                                if (null === m)
                                    return kt("NativeFunctionCall.CoerceValuesToSingleType list");
                                var g = m.TryGetItemWithValue(p, Tt.Null);
                                if (!g.exists)
                                    throw new _t("Could not find List item with the value " + p + " in " + m.name);
                    ...
                    var C = !0
                      ...
                      , b = void 0;
                    try {
                        for (var T, w = t[Symbol.iterator](); !(C = (T = w.next()).done); C = !0) {
            ...
            key: "name",
            get: function() {
                return null === this._name ? kt("NativeFunctionCall._name") : this._name
            },
            set: function(t) {
                this._name = t,
                this._isPrototype || (null === a._nativeFunctions ? kt("NativeFunctionCall._nativeFunctions") : this._prototype = a._nativeFunctions.get(this._name) || null)
            }
        }, {
            ...
            value: function() {
                if (null == this._nativeFunctions) {
                    ...
                    this.AddOpToNativeFunc(this.Equal, 2, E.DivertTarget, function(t, e) {
                        return t.Equals(e) ? 1 : 0
                    }),
                    this.AddOpToNativeFunc(this.NotEquals, 2, E.DivertTarget, function(t, e) {
                        return t.Equals(e) ? 0 : 1
                    })
                }
            }
    ...
    var M = function() {
      ...
      , G = function() {
        ...
        o(e, [{
            key: "pathStringOnChoice",
            get: function() {
                return null === this.targetPath ? kt("Choice.targetPath") : this.targetPath.toString()
            },
            set: function(t) {
        ...
        return o(n, [{
            ...
            value: function(t, e) {
                var n = !0
                  ...
                  , r = void 0;
                try {
                    for (var a, o = this._itemNameToValues[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = _(a.value, 2)
                          , s = u[0];
                        if (u[1] == t)
                            return {
                                result: new Tt(this.name,s),
                                exists: !0
                            }
                    }
                } catch (t) {
            ...
            get: function() {
                if (null == this._items) {
                    ...
                    var t = !0
                      ...
                      , n = void 0;
                    try {
                        for (var i, r = this._itemNameToValues[Symbol.iterator](); !(t = (i = r.next()).done); t = !0) {
                            var a = _(i.value, 2)
                              , o = a[0]
                              , u = a[1]
        ...
        return o(m, [{
            ...
            get: function() {
                var t = []
                  ...
                  , i = void 0;
                try {
                    for (var r, a = this._lists[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = _(r.value, 2)
                          , u = (o[0],
                        o[1]);
                        t.push(u)
      ...
      , W = function() {
        ...
        return o(E, null, [{
            ...
            value: function(t) {
                ...
                if ("string" == typeof t) {
                    var e = t.toString()
                      , n = e[0];
                    if ("^" == n)
                        return new Ot(e.substring(1));
                    if ("\n" == n && 1 == e.length)
                        return new Ot("\n");
                    if ("<>" == e)
                        return new R;
                    for (var i = 0; i < E._controlCommandNames.length; ++i) {
                        if (e == E._controlCommandNames[i])
                            return new Ft(i)
                    }
                    if ("L^" == e && (e = "^"),
                    Gt.CallExistsWithName(e))
                        return Gt.CallWithName(e);
                    if ("->->" == e)
                        return Ft.PopTunnel();
                    if ("~ret" == e)
                        return Ft.PopFunction();
                    if ("void" == e)
                        return new Mt
                }
                if ("object" === O(t) && !Array.isArray(t)) {
                    ...
                    if (a["^->"])
                        return r = a["^->"],
                        new Nt(new N(r.toString()));
                    if (a["^var"]) {
                        r = a["^var"];
                        var o = new I(r.toString());
                        return "ci"in a && (r = a.ci,
                        o.contextIndex = parseInt(r)),
                        o
                    }
                    var u = !1
                      , s = !1
                      , l = It.Function
                      , h = !1;
                    if ((r = a["->"]) ? u = !0 : (r = a["f()"]) ? (s = u = !0,
                    l = It.Function) : (r = a["->t->"]) ? (s = u = !0,
                    l = It.Tunnel) : (r = a["x()"]) && (s = !(h = u = !0),
                    l = It.Function),
                    u) {
                        var c = new Lt;
                        c.pushesToStack = s,
                        ...
                        c.isExternal = h;
                        var f = r.toString();
                        return (r = a.var) ? c.variableDivertName = f : c.targetPathString = f,
                        c.isConditional = !!a.c,
                    ...
                    if (r = a["*"]) {
                        var v = new D;
                        return v.pathStringOnChoice = r.toString(),
                        (r = a.flg) && (v.flags = parseInt(r)),
                        v
                    }
                    if (r = a["VAR?"])
                        return new Rt(r.toString());
                    if (r = a["CNT?"]) {
                        var d = new Rt;
                        return d.pathStringForCount = r.toString(),
                        d
                    }
                    var y = !1
                      , p = !1;
                    if ((r = a["VAR="]) ? p = y = !0 : (r = a["temp="]) && (p = !(y = !0)),
                    y) {
                        var m = r.toString()
                          , g = !a.re
                          , S = new Dt(m,g);
            ...
            value: function(t) {
                var e = St(t, At);
                if (e)
                    return this.ContainerToJArray(e);
                var n = St(t, Lt);
                if (n) {
                    var i, r = "->";
                    n.isExternal ? r = "x()" : n.pushesToStack && (n.stackPushType == It.Function ? r = "f()" : n.stackPushType == It.Tunnel && (r = "->t->")),
                ...
                var c = St(t, Pt);
                if (c)
                    return this.InkListToJObject(c);
                var f = St(t, Nt);
                if (f) {
                    var v = {};
                    return null === f.value ? kt("divTargetVal.value") : (v["^->"] = f.value.componentsString,
                    v)
                }
                var d = St(t, I);
                if (d) {
                    var y = {};
                    return y["^var"] = d.value,
                    y.ci = d.contextIndex,
                    y
                }
                if (St(t, R))
                ...
                var p = St(t, Ft);
                if (p)
                    return E._controlCommandNames[p.commandType];
                var m = St(t, Gt);
                if (m) {
                    var g = m.name;
                    return "^" == g && (g = "L^"),
                ...
                if (S) {
                    ...
                    return null != k ? C["CNT?"] = k : C["VAR?"] = S.name,
                    C
                }
                var b = St(t, Dt);
                if (b) {
                    var T = {};
                    return T[b.isGlobal ? "VAR=" : "temp="] = b.variableName,
                        ...
                        for (var a in r = this.DictionaryRuntimeObjsToJObject(n))
                            if (r.hasOwnProperty(a)) {
                                ...
                                if (null != o) {
                                    var u = o[o.length - 1];
                                    null != u && (delete u["#n"],
                                    0 == Object.keys(u).length && (o[o.length - 1] = null))
                                }
                            }
                    } else
                        r = {};
            ...
            value: function(t) {
                ...
                return n.list = i,
                0 == e.Count && null != e.originNames && 0 < e.originNames.length && (n.origins = e.originNames),
                n
            }
        }, {
            ...
            value: function(t) {
                var e = {}
                  ...
                  , r = void 0;
                try {
                    for (var a, o = t.lists[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = a.value
                          , s = {}
                          , l = !0
                          , h = !1
                          , c = void 0;
                        try {
                            for (var f, v = u.items[Symbol.iterator](); !(l = (f = v.next()).done); l = !0) {
                                var d = _(f.value, 2)
                                  , y = d[0]
                                  , p = d[1]
    ...
    var J = function() {
        function h() {
            ...
            arguments[0]instanceof s.Story) {
                var t = arguments[0];
                this._startOfRoot = Vt.StartOf(t.rootContentContainer),
                this.Reset()
            } else {
                var e = arguments[0]
                  , n = !0
                  ...
                  , r = void 0;
                try {
                    for (var a, o = e._threads[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = a.value;
        ...
        return o(h, [{
            ...
            value: function() {
                ...
                this._threads[0].callstack.push(new h.Element(It.Tunnel,this._startOfRoot))
            }
        }, {
            key: "SetJsonToken",
            value: function(t, e) {
            ...
            value: function() {
                var t = {}
                  ...
                  , r = void 0;
                try {
                    for (var a, o = this._threads[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = a.value;
                        e.push(u.jsonToken)
                    }
                } catch (t) {
                ...
                return t.threads = e,
                t.threadCounter = this._threadCounter,
                t
            }
        }, {
            key: "PushThread",
            ...
            set: function(t) {
                x.Assert(1 == this._threads.length, "Shouldn't be directly setting the current thread when we have a stack of them"),
                this._threads.length = 0,
                this._threads.push(t)
            }
        }, {
            ...
            get: function() {
                for (var t = new bt, e = 0; e < this._threads.length; e++) {
                    ...
                    for (var r = 0; r < n.callstack.length; r++) {
                        n.callstack[r].type == It.Function ? t.Append("  [FUNCTION] ") : t.Append("  [TUNNEL] ");
        ...
        var C = function() {
            ...
            return o(i, [{
                ...
                value: function() {
                    ...
                    return t.temporaryVariables = new Map(this.temporaryVariables),
                    ...
                    try {
                        for (var o, u = n[Symbol.iterator](); !(i = (o = u.next()).done); i = !0) {
                            ...
                            if (void 0 !== f) {
                                ...
                                null == v.obj)
                                    throw new Error("When loading state, internal story location couldn't be found: " + c + ". Has the story changed since this save data was created?");
                                if (v.approximate) {
                                    if (null === h.container)
                                        return kt("pointer.container");
                                    e.Warning("When loading state, exact internal story location couldn't be found: '" + c + "', so it was approximated to '" + h.container.path.toString() + "' to recover. Has the story changed since this save data was created?")
                                }
                            }
                            var d = !!s.exp
                              , y = new C(l,h,d)
            ...
            return o(S, [{
                ...
                value: function() {
                    ...
                    var e = !0
                      ...
                      , i = void 0;
                    try {
                        for (var r, a = this.callstack[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                            var o = r.value;
                    ...
                    return t.previousPointer = this.previousPointer.copy(),
                    t
                }
            }, {
                key: "jsonToken",
                get: function() {
                    var t = {}
                      ...
                      , r = void 0;
                    try {
                        for (var a, o = this.callstack[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                            var u = a.value
                              , s = {};
                            if (!u.currentPointer.isNull) {
                                if (null === u.currentPointer.container)
                                    return kt("el.currentPointer.container");
                                s.cPath = u.currentPointer.container.path.componentsString,
                                s.idx = u.currentPointer.index
                            }
                            s.exp = u.inExpressionEvaluation,
                            s.type = u.type,
                            s.temp = W.DictionaryRuntimeObjsToJObject(u.temporaryVariables),
                            e.push(s)
                        }
                    } catch (t) {
                        i = !0,
                    ...
                    !this.previousPointer.isNull) {
                        ...
                        if (null === l)
                            return kt("this.previousPointer.Resolve()");
    ...
    var q, K, U = function() {
        ...
        return o(n, [{
            ...
            value: function(t, e) {
                var n = !0
                  ...
                  , r = void 0;
                try {
                    for (var a, o = this.variableChangedEventCallbacks[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        (0,
                        a.value)(t, e)
                    }
                } catch (t) {
            ...
            value: function(t, e) {
                if (void 0 === e) {
                    ...
                    return void 0 === n && (n = this._defaultGlobalVariables.get(t)),
                    void 0 !== n ? n.valueObject : null
                }
                if (void 0 === this._defaultGlobalVariables.get(t))
                    throw new _t("Cannot assign to a variable (" + t + ") that hasn't been declared in the story");
                var i = xt.Create(e);
                if (null == i)
                    throw new _t(null == e ? "Cannot pass null to VariableState" : "Invalid value passed to VariableState: " + e.toString());
                this.SetGlobal(t, i)
            }
        }, {
            key: "CopyFrom",
            value: function(t) {
                if (this._globalVariables = new Map(t._globalVariables),
                this._defaultGlobalVariables = new Map(t._defaultGlobalVariables),
                this.variableChangedEvent = t.variableChangedEvent,
                this.variableChangedEventCallbacks = t.variableChangedEventCallbacks,
                t.batchObservingVariableChanges != this.batchObservingVariableChanges)
                    if (t.batchObservingVariableChanges) {
                        if (this._batchObservingVariableChanges = !0,
            ...
            value: function(t, e) {
                var n = 1 < arguments.length && void 0 !== e ? e : -1
                  ...
                  , r = St(i, I);
                return null !== r && (i = this.ValueAtVariablePointer(r)),
                i
            }
        }, {
            ...
            value: function(t, e) {
                ...
                var i = -1
                  , r = !1;
                if (r = t.isNewDeclaration ? t.isGlobal : this._globalVariables.has(n),
                t.isNewDeclaration) {
                    var a = St(e, I);
                    if (null !== a)
                        e = this.ResolveVariablePointer(a)
                } else
                    for (var o = null; null != (o = St(this.GetRawVariableWithName(n, i), I)) && (n = o.variableName,
                    r = 0 == (i = o.contextIndex)),
                    null != o; )
                        ;
            ...
            value: function(t, e) {
                var n = g(this._globalVariables, t, null);
                if (n.exists && Pt.RetainListOriginsForAssignment(n.result, e),
                null === t)
                    return kt("variableName");
                if (this._globalVariables.set(t, e),
            ...
            set: function(t) {
                if (this._batchObservingVariableChanges = t)
                    ...
                    var e = !0
                      ...
                      , i = void 0;
                    try {
                        for (var r, a = this._changedVariables[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                            var o = r.value
        ...
        return o(n, [{
            ...
            key: "GoToStart",
            value: function() {
                this.callStack.currentElement.currentPointer = Vt.StartOf(this.story.mainContentContainer)
            }
        }, {
            key: "Copy",
            value: function() {
                var t = new n(this.story);
                return t.outputStream.push.apply(t.outputStream, this._outputStream),
                this.OutputStreamDirty(),
                t._currentChoices.push.apply(t._currentChoices, this._currentChoices),
                this.hasError && (t._currentErrors = [],
                t._currentErrors.push.apply(t._currentErrors, this.currentErrors || [])),
                this.hasWarning && (t._currentWarnings = [],
                t._currentWarnings.push.apply(t._currentWarnings, this.currentWarnings || [])),
                t.callStack = new J(this.callStack),
                t._variablesState = new U(t.callStack,this.story.listDefinitions),
                t.variablesState.CopyFrom(this.variablesState),
                t.evaluationStack.push.apply(t.evaluationStack, this.evaluationStack),
                this.divertedPointer.isNull || (t.divertedPointer = this.divertedPointer.copy()),
            ...
            value: function(t) {
                ...
                null !== e && this._outputStream.push.apply(this._outputStream, e),
                this.OutputStreamDirty()
            }
        }, {
            ...
            value: function(t) {
                ...
                if (e)
                    ...
                    for (var o = -1, u = this._outputStream.length - 1; 0 <= u; u--) {
                        ...
                        if (null != l && l.commandType == Ft.CommandType.BeginString) {
                            r <= u && (r = -1);
                            break
                        }
                    }
                    if (-1 != (-1 != o && -1 != r ? Math.min(r, o) : -1 != o ? o : r)) {
                        if (n.isNewline)
                            i = !1;
                        else if (n.isNonWhitespace && (-1 < o && this.RemoveExistingGlue(),
                        -1 < r))
                            for (var h = this.callStack.elements, c = h.length - 1; 0 <= c; c--) {
                                var f = h[c];
                                if (f.type != It.Function)
                                    break;
                                f.functionStartInOutputStream = -1
                            }
                    } else
                        n.isNewline && (!this.outputStreamEndsInNewline && this.outputStreamContainsContent || (i = !1))
                }
                if (i) {
                    if (null === t)
                        return kt("obj");
                    this._outputStream.push(t),
                    this.OutputStreamDirty()
                }
            }
        }, {
            ...
            value: function() {
                for (var t = -1, e = this._outputStream.length - 1; 0 <= e; ) {
                    var n = this._outputStream[e]
                      , i = St(n, Ft)
                      , r = St(n, Ot);
                    if (null != i || null != r && r.isNonWhitespace)
                        break;
                    null != r && r.isNewline && (t = e),
                    e--
                }
                if (0 <= t)
                    for (e = t; e < this._outputStream.length; ) {
                        St(this._outputStream[e], Ot) ? this._outputStream.splice(e, 1) : e++
                    }
                this.OutputStreamDirty()
            }
        }, {
                ...
                if (e) {
                    ...
                    if (null != n.originNames) {
                        ...
                        var i = !(n.origins.length = 0)
                          ...
                          , a = void 0;
                        try {
                            for (var o, u = n.originNames[Symbol.iterator](); !(i = (o = u.next()).done); i = !0) {
                                var s = o.value;
                                if (null === this.story.listDefinitions)
                                    return kt("StoryState.story.listDefinitions");
                                var l = this.story.listDefinitions.TryListGetDefinition(s, null);
                                if (null === l.result)
                                    return kt("StoryState def.result");
                                n.origins.indexOf(l.result) < 0 && n.origins.push(l.result)
                            }
                        } catch (t) {
                            r = !0,
                            a = t
            ...
            value: function(t) {
                if (void 0 === t)
                    return d(this.evaluationStack.pop());
                if (t > this.evaluationStack.length)
                    throw new Error("trying to pop too many objects");
                return d(this.evaluationStack.splice(this.evaluationStack.length - t, t))
            }
        }, {
            ...
            value: function() {
                ...
                for (var e = this._outputStream.length - 1; t <= e; e--) {
                    ...
                    if (null != i) {
                        if (r)
                            break;
                        if (!i.isNewline && !i.isInlineWhitespace)
                            break;
            ...
            value: function(t) {
                var e = 0 < arguments.length && void 0 !== t ? t : null;
                this.callStack.currentElement.type == It.Function && this.TrimWhitespaceFromFunctionEnd(),
            ...
            value: function(t, e) {
                this.callStack.Push(It.FunctionEvaluationFromGame, this.evaluationStack.length),
            ...
            value: function() {
                return this.callStack.currentElement.type == It.FunctionEvaluationFromGame && (this.currentPointer = Vt.Null,
                this.didSafeExit = !0)
            }
        }, {
            key: "CompleteFunctionEvaluationFromGame",
            value: function() {
                if (this.callStack.currentElement.type != It.FunctionEvaluationFromGame)
                    throw new _t("Expected external function evaluation to be complete. Stack trace: " + this.callStack.callStackTrace);
                ...
                if (this.PopCallStack(It.FunctionEvaluationFromGame),
                e) {
                    if (e instanceof Mt)
                        return null;
                    var i = Ct(e, xt);
                    return i.valueType == E.DivertTarget ? i.valueObject.toString() : i.valueObject
                }
                return null
            }
        }, {
            ...
            get: function() {
                ...
                return t.isNull ? null : null === t.path ? kt("pointer.path") : t.path.toString()
            }
        }, {
            key: "currentPointer",
            get: function() {
            ...
            get: function() {
                if (this._outputStreamTextDirty) {
                    var t = new bt
                      ...
                      , i = void 0;
                    try {
                        for (var r, a = this._outputStream[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                            var o = St(r.value, Ot);
            ...
            get: function() {
                if (this._outputStreamTagsDirty) {
                    var t = !0
                      ...
                      , n = void 0;
                    try {
                        for (var i, r = this._outputStream[Symbol.iterator](); !(t = (i = r.next()).done); t = !0) {
                            var a = St(i.value, M);
            ...
            key: "jsonToken",
            get: function() {
                var t, e = {}, n = !0, i = !1, r = void 0;
                try {
                    for (var a, o = this._currentChoices[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                        var u = a.value;
                        if (null === u.threadAtGeneration)
                            return kt("c.threadAtGeneration");
                        u.originalThreadIndex = u.threadAtGeneration.threadIndex,
                        null == this.callStack.ThreadWithIndex(u.originalThreadIndex) && (null == t && (t = new Map),
                        t[u.originalThreadIndex.toString()] = u.threadAtGeneration.jsonToken)
                    }
                } catch (t) {
                    i = !0,
                    r = t
                ...
                return e.visitCounts = W.IntDictionaryToJObject(this.visitCounts),
            ...
            set: function(t) {
                ...
                if (parseInt(n) < this.kMinCompatibleLoadVersion)
                    throw new _t("Ink save format isn't compatible with the current version (saw '" + n + "', but minimum is " + this.kMinCompatibleLoadVersion + "), so can't load.");
                ...
                this.OutputStreamDirty(),
                this._currentChoices = W.JArrayToRuntimeObjList(e.currentChoices);
                ...
                var a = e.choiceThreads
                  ...
                  , s = void 0;
                try {
                    for (var l, h = this._currentChoices[Symbol.iterator](); !(o = (l = h.next()).done); o = !0) {
                        var c = l.value
                          , f = this.callStack.ThreadWithIndex(c.originalThreadIndex);
                        if (null != f)
                            c.threadAtGeneration = f.Copy();
                        else {
            ...
            get: function() {
                if (0 < this._outputStream.length)
                    for (var t = this._outputStream.length - 1; 0 <= t; t--) {
                        if (this._outputStream[t]instanceof Ft)
                            break;
                        var e = this._outputStream[t];
                        if (e instanceof Ot) {
                            if (e.isNewline)
            ...
            get: function() {
                for (var t = 0; t < this._outputStream.length; t++)
                    if (this._outputStream[t]instanceof Ot)
                        return !0;
                return !1
            }
        }, {
            ...
            get: function() {
                for (var t = this._outputStream.length - 1; 0 <= t; t--) {
                    ...
                    if (e instanceof Ft && e.commandType == Ft.CommandType.BeginString)
                        return !0
                }
                return !1
            }
    ...
    s.Story = function() {
        function h() {
            ...
            if (arguments[0]instanceof At)
                ...
                i = arguments[0];
            if (null != n && (t._listDefinitions = new j(n)),
            ...
            null !== i) {
                ...
                u != t.inkVersionCurrent && console.warn("WARNING: Version of ink used to build story doesn't match current version of engine. Non-critical, but recommend synchronising.");
                var s, l = a.root;
                if (null == l)
                    throw new Error("Root node for ink not found. Are you sure it's a valid .ink.json file?");
                (s = a.listDefs) && (t._listDefinitions = W.JTokenToListDefinitions(s)),
        ...
        o(h, [{
            ...
            value: function() {
                var t = W.RuntimeObjectToJToken(this._mainContentContainer)
                  , e = {};
                return e.inkVersion = this.inkVersionCurrent,
                e.root = t,
                null != this._listDefinitions && (e.listDefs = W.ListDefinitionsToJToken(this._listDefinitions)),
                JSON.stringify(e)
            }
        }, {
            key: "ResetState",
            ...
            value: function(t) {
                ...
                !this._asyncContinueActive) {
                    if (this._asyncContinueActive = n,
                    !this.canContinue)
                        throw new _t("Can't continue - should check canContinue before calling Continue");
                ...
                do {
                    ...
                    if (this._asyncContinueActive && i.ElapsedMilliseconds > e)
                        break
                } while (this.canContinue);i.Stop(),
                !r && this.canContinue || (null != this._stateAtLastNewline && (this.RestoreStateSnapshot(this._stateAtLastNewline),
                ...
                0 != this.state.generatedChoices.length || this.state.didSafeExit || null != this._temporaryEvaluationContainer || (this.state.callStack.CanPop(It.Tunnel) ? this.AddError("unexpectedly reached end of content. Do you need a '->->' to return from a tunnel?") : this.state.callStack.CanPop(It.Function) ? this.AddError("unexpectedly reached end of content. Do you need a '~ return'?") : this.state.callStack.canPop ? this.AddError("unexpectedly reached end of content for unknown reason. Please debug compiler!") : this.AddError("ran out of content. Do you need a '-> DONE' or '-> END'?"))),
            ...
            value: function() {
                ...
                !this.state.inStringEvaluation) {
                    if (null != this._stateAtLastNewline) {
                        ...
                        var t = this.CalculateNewlineOutputStateChange(this._stateAtLastNewline.currentText, this.state.currentText, this._stateAtLastNewline.currentTags.length, this.state.currentTags.length);
                        if (t == h.OutputStateChange.ExtendedBeyondNewline)
                            return this.RestoreStateSnapshot(this._stateAtLastNewline),
                            !0;
            ...
            value: function(t, e, n, i) {
                ...
                if (!r)
                    return h.OutputStateChange.NewlineRemoved;
                if (n < i)
            ...
            value: function(t) {
                ...
                var e = new Vt
                  , n = t.length
                  , i = null;
                return null === t.lastComponent ? kt("path.lastComponent") : (t.lastComponent.isIndex ? (n = t.length - 1,
                i = this.mainContentContainer.ContentAtPath(t, void 0, n),
                e.container = i.container,
                e.index = t.lastComponent.index) : (i = this.mainContentContainer.ContentAtPath(t),
                e.container = i.container,
                e.index = -1),
                null == i.obj || i.obj == this.mainContentContainer && 0 < n ? this.Error("Failed to find content at path '" + t + "', and no approximation of it was possible.") : i.approximate && this.Warning("Failed to find content at path '" + t + "', so it was approximated to: '" + i.obj.path + "'."),
                e)
            }
        }, {
            key: "StateSnapshot",
            ...
            value: function() {
                ...
                if (!e.isNull) {
                    for (var n = St(e.Resolve(), At); n && (this.VisitContainer(n, !0),
                    0 != n.content.length); )
                    ...
                    if (!this.state.currentPointer.isNull) {
                        ...
                        if (i instanceof At && (t = !1),
                        t) {
                            var u = St(i, I);
                            if (u && -1 == u.contextIndex) {
                                var s = this.state.callStack.ContextForVariableNamed(u.variableName);
                        ...
                        this.NextContent();
                        var l = St(i, Ft);
                        l && l.commandType == Ft.CommandType.StartThread && this.state.callStack.PushThread()
                    }
                }
            }
        }, {
            key: "VisitContainer",
            value: function(t, e) {
                t.countingAtStartOnly && !e || (t.visitsShouldBeCounted && this.IncrementVisitCountForContainer(t),
                t.turnIndexShouldBeCounted && this.RecordTurnIndexVisitToContainer(t))
            }
        }, {
            ...
            value: function() {
                ...
                if (!e.isNull && -1 != e.index) {
                    ...
                    var i = e.Resolve();
                    if (null != i)
                        for (var r = St(i.parent, At); r && (this._prevContainers.indexOf(r) < 0 || r.countingAtStartOnly); ) {
                            var a = 0 < r.content.length && i == r.content[0];
                            this.VisitContainer(r, a),
                            r = St((i = r).parent, At)
                        }
                }
            }
            ...
            value: function(t) {
                ...
                var i = ""
                  , r = "";
                t.hasChoiceOnlyContent && (r = Ct(this.state.PopEvaluationStack(), Ot).value || "");
                t.hasStartContent && (i = Ct(this.state.PopEvaluationStack(), Ot).value || "");
                t.onceOnly && 0 < this.VisitCountForContainer(t.choiceTarget) && (e = !1);
                if (!e)
                    return null;
                var a = new G;
                return a.targetPath = t.pathOnChoice,
            ...
            value: function(t) {
                ...
                if (t instanceof Lt) {
                    ...
                    if (e.hasVariableTarget) {
                        ...
                        if (null == r)
                            this.Error("Tried to divert using a target from a variable that could not be found (" + i + ")");
                        else if (!(r instanceof Nt)) {
                            var a = St(r, Et)
                              , o = "Tried to divert to a target from a variable, but the variable (" + i + ") didn't contain a divert target, it ";
                            a instanceof Et && 0 == a.value ? o += "was empty/null (the value 0)." : o += "contained '" + r + "'.",
                            this.Error(o)
                        }
                        var u = Ct(r, Nt);
                ...
                if (t instanceof Ft) {
                    ...
                    case Ft.CommandType.PopTunnel:
                        var c = s.commandType == Ft.CommandType.PopFunction ? It.Function : It.Tunnel
                          , f = null;
                        if (c == It.Tunnel) {
                            var v = this.state.PopEvaluationStack();
                            null === (f = St(v, Nt)) && this.Assert(v instanceof Mt, "Expected void if ->-> doesn't override target")
                        }
                        if (this.state.TryExitFunctionEvaluationFromGame())
                            break;
                        if (this.state.callStack.currentElement.type == c && this.state.callStack.canPop)
                            this.state.PopCallStack(),
                            f && (this.state.divertedPointer = this.PointerAtPath(f.targetPath));
                        else {
                            var d = new Map;
                            d.set(It.Function, "function return statement (~ return)"),
                            d.set(It.Tunnel, "tunnel onwards statement (->->)");
                            var y = d.get(this.state.callStack.currentElement.type);
                            this.state.callStack.canPop || (y = "end of flow (-> END or choice)");
                    ...
                    case Ft.CommandType.EndString:
                        ...
                        this.state.PopFromOutputStream(g),
                        m = m.reverse();
                        var b = new bt
                          , T = !0
                          , w = !1
                          , _ = void 0;
                        try {
                            for (var x, E = m[Symbol.iterator](); !(T = (x = E.next()).done); T = !0) {
                                var O = x.value;
                                b.Append(O.toString())
                            }
                        } catch (t) {
                    ...
                    case Ft.CommandType.Turns:
                        this.state.PushEvaluationStack(new Et(this.state.currentTurnIndex + 1));
                        break;
                    ...
                    case Ft.CommandType.ReadCount:
                        ...
                        if (!(P instanceof Nt)) {
                            var A = "";
                            P instanceof Et && (A = ". Did you accidentally pass a read count ('knot_name') instead of a target ('-> knot_name')?"),
                            this.Error("TURNS_SINCE / READ_COUNT expected a divert target (knot, stitch, label name), but saw " + P + A);
                            break
                        }
                        var I, F = Ct(P, Nt), V = St(this.ContentAtPath(F.targetPath).correctObj, At);
                        null != V ? I = s.commandType == Ft.CommandType.TurnsSince ? this.TurnsSinceForContainer(V) : this.VisitCountForContainer(V) : (I = s.commandType == Ft.CommandType.TurnsSince ? -1 : 0,
                        this.Warning("Failed to find container for " + s.toString() + " lookup at " + F.targetPath.toString())),
                    ...
                    case Ft.CommandType.Random:
                        ...
                        if (null === L.value)
                            return kt("maxInt.value");
                        if (null === R.value)
                            return kt("minInt.value");
                        var D = L.value - R.value + 1;
                        D <= 0 && this.Error("RANDOM was called with minimum as " + R.value + " and maximum as " + L.value + ". The maximum must be larger");
                    ...
                    case Ft.CommandType.VisitIndex:
                        var W = this.VisitCountForContainer(this.state.currentPointer.container) - 1;
                    ...
                    case Ft.CommandType.ListFromInt:
                        ...
                        if (null === q)
                            throw new _t("Passed non-integer when creating a list element from a numerical value.");
                        var U = null;
                        if (null === this.listDefinitions)
                            return kt("this.listDefinitions");
                        var z = this.listDefinitions.TryListGetDefinition(K.value, null);
                        if (!z.exists)
                    ...
                    case Ft.CommandType.ListRange:
                        ...
                        if (null === Q || null === $ || null === X)
                            throw new _t("Expected list, minimum and maximum for LIST_RANGE");
                        if (null === Q.value)
                            return kt("targetList.value");
                        var Y = Q.value.ListWithSubRange($.valueObject, X.valueObject);
                    ...
                    case Ft.CommandType.ListRandom:
                        ...
                        if (0 == tt.Count)
                            ...
                            for (var nt = this.state.storySeed + this.state.previousRandom, it = new Bt(nt).next(), rt = it % tt.Count, at = tt.entries(), ot = 0; ot <= rt - 1; ot++)
                                at.next();
                            var ut = at.next().value
                              , st = {
                                Key: Tt.fromSerializedKey(ut[0]),
                                Value: ut[1]
                            };
                            if (null === st.Key.originName)
                                return kt("randomItem.Key.originName");
                            (et = new wt(st.Key.originName,this)).Add(st.Key, st.Value),
                ...
                if (t instanceof Dt) {
                    ...
                    return this.state.variablesState.Assign(lt, ht),
                    !0
                }
                if (t instanceof Rt) {
                    var ct = t
                    ...
                    if (null != ct.pathForCount) {
                        ...
                        ft = new Et(dt)
                    } else if (null == (ft = this.state.variablesState.GetVariableWithName(ct.name))) {
                        var yt = this.state.variablesState.TryGetDefaultVariableValue(ct.name);
                        null != yt ? (this.Warning("Variable not found in save state: '" + ct.name + "', but seems to have been newly created. Assigning value from latest ink's declaration: " + yt),
                        ft = yt,
                        this.state.variablesState.SetGlobal(ct.name, ft)) : (this.Warning("Variable not found: '" + ct.name + "'. Using default value of 0 (false). This can happen with temporary variables if the declaration hasn't yet been hit."),
                        ft = new Et(0))
                    }
                    return this.state.PushEvaluationStack(ft),
                    !0
                }
                if (t instanceof Gt) {
                    var pt = t
                      ...
                      , gt = pt.Call(mt);
                    return this.state.PushEvaluationStack(gt),
                    !0
                }
                return !1
            }
            ...
            value: function(t, e, n) {
                ...
                i)
                    this.ResetCallstack();
                else if (this.state.callStack.currentElement.type == It.Function) {
                    var a = ""
                      , o = this.state.callStack.currentElement.currentPointer.container;
                    throw null != o && (a = "(" + o.path.toString() + ") "),
                    new Error("Story was running a function " + a + "when you called ChoosePathString(" + t + ") - this is almost certainly not not what you want! Full stack trace: \n" + this.state.callStack.callStackTrace)
                }
            ...
            value: function(t) {
                ...
                var n = e[t];
                return null === n.threadAtGeneration ? kt("choiceToChoose.threadAtGeneration") : null === n.targetPath ? kt("choiceToChoose.targetPath") : (this.state.callStack.currentThread = n.threadAtGeneration,
            ...
            value: function(t, e, n) {
                var i = 1 < arguments.length && void 0 !== e ? e : []
                  , r = 2 < arguments.length && void 0 !== n && n;
                if (this.IfAsyncWeCant("evaluate a function"),
                null == t)
            ...
            value: function(t) {
                ...
                n < this.state.evaluationStack.length ? this.state.PopEvaluationStack() : null
            }
        }, {
            ...
            value: function(t, e) {
                ...
                if (!(void 0 !== n)) {
                    if (this.allowExternalFunctionFallbacks)
                        ...
                        this.state.callStack.Push(It.Function, void 0, this.state.outputStream.length),
                ...
                var u = n(r)
                  , s = null;
                null != u ? (s = xt.Create(u),
                this.Assert(null !== s, "Could not create ink value from returned object of type " + O(u))) : s = new Mt,
            ...
            value: function(t, e) {
                ...
                t instanceof P && (i = t),
                null === n && null === i)
                    if (this.ValidateExternalBindings(this._mainContentContainer, r),
                    ...
                    0 == r.size)
                        ...
                        a += Array.from(r).join("', '"),
                        a += "' ",
                        a += this.allowExternalFunctionFallbacks ? ", and no fallback ink function found." : " (ink fallbacks disabled)",
                        this.Error(a)
                    }
                else if (null != n) {
                    var o = !0
                      ...
                      , s = void 0;
                    try {
                        for (var l, h = n.content[Symbol.iterator](); !(o = (l = h.next()).done); o = !0) {
                            var c = l.value;
                            null != c && c.hasValidName || this.ValidateExternalBindings(c, r)
                        }
                    } catch (t) {
                        u = !0,
                        s = t
                    ...
                    var f = !0
                      ...
                      , d = void 0;
                    try {
                        for (var y, p = n.namedContent[Symbol.iterator](); !(f = (y = p.next()).done); f = !0) {
                            var m = _(y.value, 2)
                              , g = (m[0],
                            m[1]);
            ...
            value: function(t, e) {
                ...
                !this.state.variablesState.GlobalVariableExistsWithName(t))
                    throw new _t("Cannot observe variable '" + t + "' because it wasn't declared in the ink story.");
                ...
                null !== this._variableObservers)
                    if (void 0 !== e) {
                        ...
                        var i = this._variableObservers.keys()
                          ...
                          , o = void 0;
                        try {
                            for (var u, s = i[Symbol.iterator](); !(r = (u = s.next()).done); r = !0) {
                                var l = u.value
            ...
            value: function(t) {
                ...
                var r = null
                  ...
                  , u = void 0;
                try {
                    for (var s, l = n.content[Symbol.iterator](); !(a = (s = l.next()).done); a = !0) {
                        var h = St(s.value, M);
                        if (!h)
                            break;
                        null == r && (r = []),
            ...
            value: function() {
                ...
                this.state.currentPointer.isNull)) && !this.IncrementContentPointer()) {
                    var t = !1;
                    this.state.callStack.CanPop(It.Function) ? (this.state.PopCallStack(It.Function),
                    this.state.inExpressionEvaluation && this.state.PushEvaluationStack(new Mt),
            ...
            value: function() {
                ...
                if (0 == e.length || t.length > e.length)
                    return !1;
                var n = e[0];
                return null === n.targetPath ? kt("choice.targetPath") : null === n.threadAtGeneration ? kt("choice.threadAtGeneration") : (this.state.callStack.currentThread = n.threadAtGeneration,
            ...
            value: function(t) {
                ...
                if (!t.visitsShouldBeCounted)
                    return console.warn("Read count for target (" + t.name + " - on " + t.debugMetadata + ") unknown. The story may need to be compiled with countAllVisits flag (-c)."),
                    0;
                var e = 0
                  , n = t.path.toString();
            ...
            value: function(t) {
                var e = 0
                  , n = t.path.toString();
                this.state.visitCounts.has(n) && (e = this.state.visitCounts.get(n)),
                e++,
            ...
            value: function() {
                ...
                if (null === e)
                    return kt("seqContainer");
                if (null === t.value)
                    return kt("numElementsIntVal.value");
                var n = t.value
                  , i = Ct(this.state.PopEvaluationStack(), Et).value;
                if (null === i)
                    return kt("seqCount");
                for (var r = i / n, a = i % n, o = e.path.toString(), u = 0, s = 0, l = o.length; s < l; s++)
                    u += o.charCodeAt(s) || 0;
                for (var h = u + r + this.state.storySeed, c = new Bt(Math.floor(h)), f = [], v = 0; v < n; ++v)
                    f.push(v);
                for (var d = 0; d <= a; ++d) {
            ...
            value: function(t, e, n) {
                ...
                if (null != a) {
                    ...
                    t = "RUNTIME " + o + ": '" + a.fileName + "' line " + u + ": " + t
                } else
                    t = this.state.currentPointer.isNull ? "RUNTIME " + o + ": " + t : "RUNTIME " + o + ": (" + this.state.currentPointer + "): " + t;
                this.state.AddError(t, i),
                i || this.state.ForceEnd()
            }
        }, {
            key: "Assert",
            value: function(t, e) {
            ...
            get: function() {
                ...
                var e = !0
                  ...
                  , i = void 0;
                try {
                    for (var r, a = this._state.currentChoices[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                        var o = r.value;
                        o.isInvisibleDefault || (o.index = t.length,
                        t.push(o))
                    }
                } catch (t) {
                    n = !0,
            ...
            get: function() {
                ...
                if (!e.isNull && null !== e.Resolve() && null !== (t = e.Resolve().debugMetadata))
                    return t;
                for (var n = this.state.callStack.elements.length - 1; 0 <= n; --n)
    ...
    q = s.Story || (s.Story = {}),
    (K = q.OutputStateChange || (q.OutputStateChange = {}))[K.NoChange = 0] = "NoChange",
